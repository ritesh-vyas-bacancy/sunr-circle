-- ============================================================
-- SUNR Circle — FULL SETUP SQL
-- Step 1: Go to https://supabase.com/dashboard/project/oaftuyikaxgzlyyzgenk/editor
-- Step 2: Paste this ENTIRE script and click RUN
-- Step 3: Wait for completion (~10-15 seconds)
-- ============================================================
...
INSERT INTO system_settings (organization_id, key, value, description) VALUES
  ('a0000000-0000-0000-0000-000000000001', 'sla_hours_threshold', '24', 'Hours before SLA breach'),
  ('a0000000-0000-0000-0000-000000000001', 'default_locale', 'en', 'Default locale'),
  (NULL, 'system_version', '1.0.0', 'System version')
